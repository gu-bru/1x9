(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1x9.loader.js";
    var config = {
        dataUrl: buildUrl + "/1x9.data",
        frameworkUrl: buildUrl + "/1x9.framework.js",
        codeUrl: buildUrl + "/1x9.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer, 2022 CC0",
        productName: "1x9 - Mathe mit Spass",
        productVersion: "1.5 vom 6.8.2023",
    };
